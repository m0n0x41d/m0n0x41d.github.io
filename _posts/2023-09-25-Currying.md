...
{:refdef: style="display: block; margin: 0 auto; max-width: 95%; height: auto;"}
![Currying](/assets/images/lambda_currying.png)
{: refdef}
*<center>"look everybody I'm so clever elite one-liners fucker" coding style</center>*
...
![Uncle Ben](/assets/images/uncle_ben.jpeg)
{: refdef2}
