...
export const About = ({ data = {}, lang = 'en' }: AboutProps) => {
    ...
    const translations = {
        ...
        ru: {
            title: "Обо мне",
            defaultText: `<p>Имея более семи лет опыта в разработке программного обеспечения, я приобрел глубокие знания в проектировании и реализации масштабируемых программных систем.</p>
            <p>Моя экспертиза охватывает все от баз данных, облачной инфраструктуры, распределенных систем до следования в разработке как <span>классическим</span>, так и <span>SoTA</span> инженерным принципам.</p>
            <p>Я специализируюсь на архитектуре платформ и интеграции систем на база генеративного ИИ.</p>
            ...
            <p>Благодаря разностороннему опыту я построил техническую экспертизу, которая охватывает базы данных, облачные инфраструктуры, распределенные (и монолитные) системы, а также привычку следования как классическим, так и <span>SoTA</span> инженерным принципам.</p>
            <p>Я специализируюсь на архитектуре платформ, разработке и интеграции систем ИИ. Но все самое главное начинается с <span>системной инженерии.</span></p>
            <p>Я всегда стараюсь подходить к каждой конкретной области внимательно и осторожно, собирая как можно больше метрик о ситуации и бизнес-целях, вместо того чтобы сломя голову нестись внедрять "современные архитектурные паттерны" потому что <i>"так делают все"</i>.</p>
            ...
            <p>Моя консультационная методика основана на убеждении, что бизнес это такая же сложная система, как и любая программная, они взаимосвязаны и поэтому надо разбираться с ними вместе. Технологии должны служить людям и бизнес-целям, а не наоборот. Когда я работаю с клиентами, я следую такому структурированному процессу:</p>
            <ol>
            ...
            <p>Независимо от того, сталкиваетесь ли вы с конкретными техническими проблемами или ищете стратегическую поддержку по разработке надежной дорожной карты вашей системы, я приветствую возможность найти применение моему опыту в ваших интересах. Я беру на себя консультационные проекты на основе взаимного соответствия и потенциала воздействия.</p>
